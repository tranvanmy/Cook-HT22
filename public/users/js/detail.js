$(document).ready(function () {
    ...
    $('#calRation').on('click', function () {
        ...
        $.ajax({
            ...
            success: function (data) {
                alertify.notify('Thay đổi số lượng thành công', 'success', 5, function() {});
    ...
    $('#submit-review').on('click', function () {
        if (rate == 0) {
            alertify.notify('Bạn chưa nhập lượt bình chọn', 'error', 5, function() {});
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    alertify.notify('Đánh giá thành công', 'success', 5, function() {});
                    swal('Đánh giá thành công');
                },

                error: function(data){
                    alertify.notify('Đánh giá thất bại', 'success', 5, function() {});
                }
            });
            $("#review-content").val("");
        }
    ...
    $('.reply').on('click', function () {
        ...
        $.post(
            ...
            function (data) {
                ...
                alertify.notify('Bình luận thành công', 'success', 5, function() {});
