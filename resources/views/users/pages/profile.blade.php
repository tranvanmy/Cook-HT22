...
<div class="container">
    <div class="card hovercard">
        <div class="card-background">
            <img class="card-bkimg" alt="" src="{{ asset('users/imgs/Strawberry-raspberry-blackberry-blueberry-berries_cropped.jpg') }}">
        </div>
    ...
    <div class="profile-left">
        <div class="profile-sidebar">
            ...
            <div class="profile-userbuttons">
                ...
                <button type="button" class="btn btn-danger btn-sm">{{ trans("sites.edit") }} {{ trans("sites.information") }}</button>
            </div>
            <!-- END SIDEBAR BUTTONS -->
        </div>
    </div>
                                        ...
                                        <div class="featured-recipe-item">
                                            <div class="recipe-photo">
                                                <a href="#">
                                                    ...
                                                    <img alt="Cà phê trứng ngon chuẩn" src="{{ asset('users/imgs/coupon-contest.jpg') }}">
                                                </a>
                                            </div>
                                            <div class="item-info-box">
                                                <h3 class="title"><a href="#" >Cà phê trứng ngon chuẩn</a></h3>
                                                <div class="desc">Cà phê trứng là một món đồ uống từ lâu đã rất nổi tiếng tại Việt Nam, không những cuốn hút người Việt mà người nước ngoài khi sang Việt Nam cũng rất t...
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="item-header">
                                        <div class="hprofile">
                                            <div class="avt"><a href="#"> <img
                                                    src="{{ asset('users/imgs/coupon-contest.jpg') }}" class="img-responsive"> </a></div>
                                            <div class="profile">
                                                <div class="postedby-text">{{ trans("sites.receipt") }} {{ trans("sites.createby") }}:</div>
                                                <a href="#"> Anh Nguyen </a>
                                            </div>
                                        </div>
                                    </div>
