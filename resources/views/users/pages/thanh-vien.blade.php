                        ...
                        <div class="member-item">
                            <div class="member-profile nopadding">
                                <div class="avatar z-effect">
                                    <img class="img-responsive img-circle" src="{{ asset('users/imgs/cook-together.jpg') }}">
                                </div>
                                <div class="profile">
                                    <a class="cooky-user-link name" data-userid="62838" href="#" data-hasqtip="62838">Ayumi
                                        Trang </a>
                                    <span class="stats-text user-lvl newbee">newbee</span>
                                    <div class="stats">
