...
<button type="button" class="btn btn-primary btn-ms" data-toggle="modal" data-target="#addCate"> 
    {{ trans("sites.add") }}
</button><br><br>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="post" action="{{ route('postAddCate') }}" id="frm-cate-add">
                    ...
                    <input type="text" class="form-control" id="name_cate" name="name_cate" value=""/>
